...
from fcs_trade.trader.engine import BaseEngine, MainEngine
from fcs_trade.trader.constant import Interval
from fcs_trade.trader.utility import extract_vt_symbol
from fcs_trade.trader.object import HistoryRequest
from fcs_trade.trader.rqdata import rqdata_client
from fcs_trade.trader.database import database_manager
from fcs_trade.app.cta_strategy import (
    CtaTemplate,
    BacktestingEngine,
    OptimizationSetting
)
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "fcs_trade.app.cta_strategy.strategies")
